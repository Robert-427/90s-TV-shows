...
namespace NinetiesTV
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Print("Number of ShowsFrom 1987 - 2018", NumShowsFromRandomRange(shows));
            Print("How long to binge each show", BingeTime(shows));
            Print("Year with show that has highest IMDB rating", HighestYearIMDB(shows));
        }
        ...
        **************************************************************************************************/
        ...
        {
            return shows.OrderByDescending(s => s.ImdbRating).First(s => s.Genres.Contains("Drame"));
        }
        ...
        **************************************************************************************************/
        ...
        public static int HighestYearIMDB(List<Show> shows)
        {
            return shows
